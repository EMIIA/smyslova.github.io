...
(lib.круги_HTML5Canvas = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(1041.2,797.8,1,1,0,0,0,-0.1,-0.8);
	...
	this.instance_1.setTransform(699.5,533.5,1,1,0,0,0,-0.1,-0.8);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(9).to({_off:false},0).wait(41).to({x:703,y:456.1,startPosition:41},0).to({_off:true},1).wait(10));

	// КРУГ 1
	this.instance_2 = new lib.КРУГ("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(99.2,852.1,1,1,0,0,0,-253.9,52.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(41).to({x:-48.8,y:892.1,startPosition:41},0).to({_off:true},1).wait(19));
...
p.nominalBounds = new cjs.Rectangle(440,540,1921,1081);
// library properties:
lib.properties = {
